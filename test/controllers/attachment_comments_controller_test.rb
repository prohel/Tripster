...
class AttachmentCommentsControllerTest < ActionController::TestCase
  ...
  test "should create attachment_comment" do
    assert_difference('AttachmentComment.count') do
      post :create, attachment_comment: { attachment_id: @attachment_comment.attachment_id, text: @attachment_comment.text, user_id: @attachment_comment.user_id }
    end
  ...
  test "should update attachment_comment" do
    patch :update, id: @attachment_comment, attachment_comment: { attachment_id: @attachment_comment.attachment_id, text: @attachment_comment.text, user_id: @attachment_comment.user_id }
    assert_redirected_to attachment_comment_path(assigns(:attachment_comment))
  end
