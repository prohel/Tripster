...
class AlbumCommentsControllerTest < ActionController::TestCase
  ...
  test "should create album_comment" do
    assert_difference('AlbumComment.count') do
      post :create, album_comment: { album_id: @album_comment.album_id, text: @album_comment.text, user_id: @album_comment.user_id }
    end
  ...
  test "should update album_comment" do
    patch :update, id: @album_comment, album_comment: { album_id: @album_comment.album_id, text: @album_comment.text, user_id: @album_comment.user_id }
    assert_redirected_to album_comment_path(assigns(:album_comment))
  end
